...
public class View_Autokey {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Autokey window = new View_Autokey();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Autokey");
	...
	private void btn_encryptActionPerformed(ActionEvent evt) {
		try {
			...
			String ct = AutokeyCipher.encrypt(plaintext, keyStr);
	...
	private void btn_decryptActionPerformed(ActionEvent evt) {
		try {
			...
			String ct = AutokeyCipher.decrypt(cipherText, keyStr);
