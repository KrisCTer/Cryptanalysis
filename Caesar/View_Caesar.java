...
public class View_Caesar {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Caesar window = new View_Caesar();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Caesar");
	...
	private void btn_encryptActionPerformed(ActionEvent evt) {
		try {
			...
			String ct = CaesarCipher.encript(plaintext, k);
	...
	private void btn_decryptActionPerformed(ActionEvent evt) {
		try {
			...
			int k = Integer.parseInt(this.key.getText());
			String ct = CaesarCipher.decript(ciphertextToDe, k);
