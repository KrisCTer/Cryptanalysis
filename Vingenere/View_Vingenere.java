...
public class View_Vingenere {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Vingenere window = new View_Vingenere();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Vingenere");
	...
	private void btn_encryptActionPerformed(ActionEvent evt) {
		try {
			...
			String k = this.key.getText();
			String ct = VingenereCipher.encript(plaintext, k);
	...
	private void btn_decryptActionPerformed(ActionEvent evt) {
		try {
			...
			String k = this.key.getText();
			String ct = VingenereCipher.decript(ciphertextToDe, k);
